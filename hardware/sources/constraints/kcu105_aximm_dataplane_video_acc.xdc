...
set_property LOC [get_package_pins -filter {PIN_FUNC == IO_T3U_N12_PERSTN0_65}] [get_ports perst_n]
...
#### FALSE PATHS #####
set_false_path -from [get_pins u_trd/trd_i/user_axilite_control_0/inst/axi_lite_ipif_inst/I_SLAVE_ATTACHMENT/bus2ip_addr_reg_reg[*]/C]
set_false_path -from [get_pins u_trd/trd_i/nwl_dma_x8g3_wrapper_0/inst/mc_dma/util_sync_flops_p_is_rp_ep_n/s1_reg/C]
set_false_path -from [get_pins u_trd/trd_i/proc_sys_reset_0/U0/ACTIVE_LOW_BSR_OUT_DFF[0].interconnect_aresetn_reg[0]/C]
set_false_path -from [get_pins u_trd/trd_i/proc_sys_reset_0/U0/PR_OUT_DFF[0].peripheral_reset_reg[0]/C]
...
########################
#Actual Pblock constraints which worked when Tandem PCIe was not enabled
########################
