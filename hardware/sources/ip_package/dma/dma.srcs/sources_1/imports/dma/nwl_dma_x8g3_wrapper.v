...
module nwl_dma_x8g3_wrapper #(
    ...
    parameter   P_DATA_WIDTH                        = 256,                      // PCI Express Core Data Width
    ...
    output  [21:0]                              m_awuser,                   // Write Address Channel - non-standard AXI ports
    ...
    output  [21:0]                              m_aruser,                 // Read Address Channel - non-standard AXI ports
...
*/
    ...
    parameter   DMA_AXI_M_R_BADDR_WIDTH             = 13;   // AXI  Master Read Reorder Queue == 2^DMA_AXI_M_R_BADDR_WIDTH  bytes
...
assign cfg_vf_flr_done[7] = ~cfg_vf_flr_done_reg1[7] && cfg_vf_flr_done_reg0[7];
  ...
  assign  cfg_dev_id         = 16'h8083;   
  assign  cfg_subsys_id      = 16'h8083;                                
...
mc_dma2 #(
    ...
    .DMA_AXI_M_R_BADDR_WIDTH        (DMA_AXI_M_R_BADDR_WIDTH        ),
    ...
    .sgl_alloc_ready                (), 
    .sgl_alloc_num_sgl              (3'd0),
    .sgl_alloc_dst_src_n            (1'b0),
    .sgl_alloc_channel              (2'd0),
    .sgl_alloc_src_full             (),
    .sgl_alloc_src_aready           (),
    .sgl_alloc_src_empty            (),
    .sgl_alloc_dst_full             (),
    .sgl_alloc_dst_aready           (),
    .sgl_alloc_dst_empty            (),
