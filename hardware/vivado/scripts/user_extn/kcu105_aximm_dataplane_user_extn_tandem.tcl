...
set proj_dir runs_user_extn_tandem
...
# Project Settings
add_files -fileset constrs_1 -norecurse ${constraints_dir}/kcu105_aximm_dataplane_video_acc.xdc
set_property used_in_synthesis true [get_files ${constraints_dir}/kcu105_aximm_dataplane_video_acc.xdc]

add_files -fileset constrs_1 -norecurse ${constraints_dir}/tandem.xdc
set_property used_in_synthesis true [get_files ${constraints_dir}/tandem.xdc]

set_property ip_repo_paths ${source_dir}/ip_package [current_fileset]
update_ip_catalog

# BD for design
source video_design_tandem_bd.tcl 
...
set_property STEPS.OPT_DESIGN.TCL.POST ../../../scripts/common/tandem_BSCAN_post_opt.tcl [get_runs impl_1]
